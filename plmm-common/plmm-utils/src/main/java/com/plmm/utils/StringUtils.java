...
import com.plmm.support.StrFormatter;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    public void half2FullTest(){

        String str="asdfghjkl<>?L:%";
        System.out.println("原str:"+str);
        System.out.println("转str:"+half2Full(str));
    }
     ...
     * @return
     */
    public static List<Long> toList(String str,String sep){
        ...
        if(StringUtils.isNotEmpty(str)) {
            String[] idArray = StringUtils.split(str, sep);
