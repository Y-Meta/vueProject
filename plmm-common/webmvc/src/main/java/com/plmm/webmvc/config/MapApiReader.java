...
public class MapApiReader implements ParameterBuilderPlugin {
	...
	private static MapApiReader instance =  new MapApiReader();
	
    @Autowired
    private TypeResolver typeResolver;
    
    private MapApiReader(){ }
    
    public static MapApiReader getInstance() {
       return instance;
    }
    ...
    public void init(){
       instance = this;
       instance.typeResolver = this.typeResolver;
    }
    ...
    private final static String basePackage = "com.plmm.";  //动态生成的Class名
